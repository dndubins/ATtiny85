...
Note 1: To save more power, set all output pins to INPUT mode before sleep, then set them to OUTPUT mode after wake.
...
#define sw1 0               // use PB0 for switch (physical pin 5)
