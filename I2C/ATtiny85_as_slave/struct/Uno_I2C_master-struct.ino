/* Uno_I2C_master-struct.ino
   Uno as an I2C Master, with Attiny85 as slave. Programmed with ATtiny85_I2C_slave-struct.ino.
   Author: David Dubins
   Date: 10-Feb-25
...
void sendToSlave(char* a) {
  ...
  Wire.write(a,sizeof(myStruct));  // Send the data as the char array myCharArr
